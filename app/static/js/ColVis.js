...
ColVis.prototype = {
	...
	"_fnDomColumnButton": function ( i )
	{
		...
		nButton.className = !dt.bJUI ? "ColVis_Button btn-default btn TableTools_Button" :
			"ColVis_Button btn-default btn TableTools_Button ui-button ui-state-default";
		nButton.appendChild( nSpan );
	...
	"_fnDomBaseButton": function ( text )
	{
		...
		nButton.className = !this.s.dt.bJUI ? "ColVis_Button btn btn-default TableTools_Button" :
			"ColVis_Button btn btn-default TableTools_Button ui-button ui-state-default";
		nButton.appendChild( nSpan );
